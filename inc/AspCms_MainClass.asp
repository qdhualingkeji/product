...
Dim action : action = filterPara(getForm("action", "both")) '²Ù×÷

Dim runStr : runStr="?"
if runMode=1 then runStr=""

Dim keys : keys=filterPara(getForm("key","get"))	'ËÑË÷¹Ø¼ü´Ê
Dim searchStyle : searchStyle=filterPara(getForm("searchstyle","get"))	'ËÑË÷ÀàÐÍ
Dim orderAsc : orderAsc ="asc"	'ÅÅÐò×Ö¶ÎÅÅÐò¹æÔò(asc,desc)
