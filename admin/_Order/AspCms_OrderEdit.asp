...
<body>
    ...
    <div class="right_title"><strong class="txt_C3">查看订单信息</strong></div>
    <div class="main_center_article" id="web_main">
    <div class="main_form"  style=" background:#e8f1f6">
    	<div class="main_form_news_l"><strong>订单信息</strong></div>
    </div>
    <form action="?action=edit&page=<%=page%>&order=<%=order%>&sort=<%=sortID%>&keyword=<%=keyword%>" method="post" name="form">
        ...
        <div class="main_form_txt">订单名称：</div>
        <div class="main_form_input"> 
            <input type="text"  name="OrderName" disabled="disabled"  value="<%=OrderName%>"/>
            <input type="hidden"  name="OrderID" value="<%=OrderID%>"/>
        </div>
        </div>
        <div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''"><div class="main_form_txt">订购数量：</div>
        <div class="main_form_input">
        ...
        <div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''"><div class="main_form_txt">查看状态：</div>
        <div class="main_form_input"> 
		...
		<div class="main_form_input">
		  <input type="button"  value=" 返回 " class="btn" onclick="location.href='AspCms_Orders.asp'"/>
		</div>
		</div>
    </form>
    </div>
