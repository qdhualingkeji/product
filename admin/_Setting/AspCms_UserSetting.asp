...
<body>
  ...
  <div class="right_title"><strong class="txt_C3">会员注册设置</strong></div>
  <div class="main_center_article" id="web_main">
	  <form action="?action=editseo" method="post" name="form">
	  	<div class="main_form"  style=" background:#e8f1f6">
	  	  <div class="main_form_news_l"><strong>会员注册可选项</strong></div>
	  	  </div>
          
		<div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''">
		  <div class="main_form_txt">性别：</div>
		  <div class="main_form_input">
		    <input type="checkbox" value=""/>
	    </div></div>
		<div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''">
		  <div class="main_form_txt">邮箱：</div>
		  <div class="main_form_input">
		    <input type="checkbox" value=""/>
	    </div></div>
		<div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''">
		  <div class="main_form_txt">QQ：</div>
		  <div class="main_form_input">
		    <input type="checkbox" value=""/>
		  </div>
		</div>
		<div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''">
		  <div class="main_form_txt">联系电话：</div>
		  <div class="main_form_input">
		    <input type="checkbox" value=""/>
		  </div></div>
          
		<div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''">
		  <div class="main_form_txt">地址：</div>
		  <div class="main_form_input">
		    <input type="checkbox" value=""/>
		  </div>
		</div>		
		...
		<div class="main_form" onmouseover="this.style.backgroundColor='#e8f1f6'" onmouseout="this.style.backgroundColor=''">
		  <div class="main_form_txt">扩展字段：</div>
		  <div class="main_form_input">          
