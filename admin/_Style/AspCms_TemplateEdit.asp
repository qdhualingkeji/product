...
<body>
  ...
  <div class="right_title"><strong class="txt_C3">风格模板管理-编辑模板</strong></div>
  <div class="main_center_article" id="web_main">
	  <form action="?action=editfile" method="post" name="form">
	  	<div class="main_form"  style=" background:#e8f1f6">
	  	  <div class="main_form_news_l"><strong>编辑模板</strong></div>
	  	  </div>        
		...
		<div class="main_form_input"> 
            <textarea cols="80" rows="3" name="filetext" style=" height:320px;" ><%=encodeHtml(filetext)%></textarea>
		</div>
		</div>		
